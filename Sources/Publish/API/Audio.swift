...
public struct Audio: Hashable, Sendable {
  ...
  ///   - byteSize: The audio's file size (in bytes).
  public init(
    url: URL,
...
extension Audio {
  ...
  public struct Duration: Hashable, Sendable {
    ...
    /// Initialize a new instance of this type.
    /// - Parameters:
    ///   - hours: The duration's number of hours.
    ///   - minutes: The duration's number of minutes.
    ///   - seconds: The duration's number of seconds.
