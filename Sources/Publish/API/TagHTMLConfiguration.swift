...
public struct TagHTMLConfiguration: Sendable {
  ...
  /// - Parameters:
  ///   - basePath: The based path of all of the site's tag HTML.
  ///   - listContent: The site's tag list page content.
  ///   - detailsContentResolver: Any closure used to resolve
...
extension TagHTMLConfiguration {
