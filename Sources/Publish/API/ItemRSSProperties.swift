...
public struct ItemRSSProperties: Codable, Hashable, Sendable {
  ...
  /// - Parameters:
  ///   - guid: Any specific GUID that should be added for the item.
  ///   - titlePrefix: Any prefix that should be added to the item's title.
  ///   - titleSuffix: Any suffix that should be added to the item's title.
  ///   - bodyPrefix: Any prefix that should be added to the item's body HTML.
  ///   - bodySuffix: Any suffix that should be added to the item's body HTML.
  ///   - link: Any specific URL that the item should link to, other than its location.
  public init(
    guid: String? = nil,
