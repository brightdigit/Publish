...
extension Predicate {
  ...
  public static var any: Self { Predicate { _ in true } }
...
// These key-path operators take non-Predicate operands (a KeyPath and a value),
// so they cannot be expressed as static members of Predicate; they must remain
// free operator functions to preserve the public API.
